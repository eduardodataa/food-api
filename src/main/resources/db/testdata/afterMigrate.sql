...
insert into algafood.restaurante (nome, cozinha_id, taxa_frete, data_atualizacao, data_cadastro, ativo, aberto) values ('Rocco', 4, 20,utc_timestamp, utc_timestamp, true, true);
insert into algafood.restaurante (nome, cozinha_id, taxa_frete, data_atualizacao, data_cadastro, ativo, aberto) values ('La Boheme', 4, 20,utc_timestamp, utc_timestamp, true, true);
...
INSERT INTO algafood.produto (ativo, descricao, nome, preco, restaurante_id) VALUES(1, 'Peixa Branco', 'Sashimi', 10, 1);
INSERT INTO algafood.produto (ativo, descricao, nome, preco, restaurante_id) VALUES(1, 'Peixa salmão', 'Sashimi', 10, 1);
